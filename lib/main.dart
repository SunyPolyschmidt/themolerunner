...
void main() async{
  runApp(Title(
    ...
    child: Container(
      ...
      child: MoleRunnerWrapper(),
    ),
  ));
  SystemChrome.setEnabledSystemUIOverlays([]);
}
class MoleRunnerWrapper extends StatefulWidget {

  @override
  _MoleRunnerWrapper createState() => _MoleRunnerWrapper();
}

class _MoleRunnerWrapper extends State<MoleRunnerWrapper> {
